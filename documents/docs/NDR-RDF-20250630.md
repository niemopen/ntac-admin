...
Given that there are two popular yet incompatible meanings of "object", it is probably unrealistic
to completely eliminate one usage or the other. But given that incompatible usages of object-related terms exist:
...
should be agreed. CMF currently uses "Object" in the "complex content" sense; the (recommended)
